namespace TrackerUI
{
	partial class CreateTournamentForm
	{
		...
		private void InitializeComponent()
		{
			...
			LSB_TournamentTeams = new ListBox();
			LBL_TeamsPlayers = new Label();
			BTN_RemoveTeam = new Button();
			...
			LNK_AddNewTeam.Size = new Size(52, 15);
			LNK_AddNewTeam.TabIndex = 9;
			LNK_AddNewTeam.TabStop = true;
			LNK_AddNewTeam.Text = "Create +";
			LNK_AddNewTeam.LinkClicked += LNK_AddNewTeam_LinkClicked;
			// 
			// BTN_AddTeam
			// 
			...
			// LSB_TournamentTeams
			// 
			LSB_TournamentTeams.BorderStyle = BorderStyle.FixedSingle;
			LSB_TournamentTeams.FormattingEnabled = true;
			LSB_TournamentTeams.ItemHeight = 15;
			LSB_TournamentTeams.Location = new Point(375, 101);
			LSB_TournamentTeams.Name = "LSB_TournamentTeams";
			LSB_TournamentTeams.Size = new Size(260, 122);
			LSB_TournamentTeams.TabIndex = 17;
			LSB_TournamentTeams.SelectedIndexChanged += LSB_TournamentPlayers_SelectedIndexChanged;
			// 
			// LBL_TeamsPlayers
			// 
			...
			// BTN_RemoveTeam
			// 
			BTN_RemoveTeam.FlatAppearance.BorderColor = Color.Silver;
			BTN_RemoveTeam.FlatAppearance.MouseDownBackColor = Color.FromArgb(102, 102, 102);
			BTN_RemoveTeam.FlatAppearance.MouseOverBackColor = Color.FromArgb(242, 242, 242);
			BTN_RemoveTeam.FlatStyle = FlatStyle.Flat;
			BTN_RemoveTeam.Font = new Font("Segoe UI Semibold", 16F, FontStyle.Bold, GraphicsUnit.Point);
			BTN_RemoveTeam.ForeColor = SystemColors.MenuHighlight;
			BTN_RemoveTeam.Location = new Point(656, 122);
			BTN_RemoveTeam.Name = "BTN_RemoveTeam";
			BTN_RemoveTeam.Size = new Size(139, 78);
			BTN_RemoveTeam.TabIndex = 19;
			BTN_RemoveTeam.Text = "Remove Team";
			BTN_RemoveTeam.UseVisualStyleBackColor = true;
			BTN_RemoveTeam.Click += BTN_DeletePlayer_Click;
			// 
			...
			BTN_DeleteSelectedPrize.Text = "Delete Prize";
			BTN_DeleteSelectedPrize.UseVisualStyleBackColor = true;
			BTN_DeleteSelectedPrize.Click += BTN_DeleteSelectedPrize_Click;
			// 
			// LBL_Prizes
			// 
			...
			Controls.Add(BTN_RemoveTeam);
			Controls.Add(LBL_TeamsPlayers);
			Controls.Add(LSB_TournamentTeams);
		...
		private ListBox LSB_TournamentTeams;
	}
}